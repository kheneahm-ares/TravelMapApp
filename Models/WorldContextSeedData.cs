...
namespace TheWorld.Models
{
    public class WorldContextSeedData
    {
        ...
        public async Task EnsureSeedData()
        {
            ...
            //if user doesnt exist yet then create user
            if(await _userManager.FindByEmailAsync("kares@aol.com") == null)
            {
                var user = new WorldUser()
                {
                    UserName = "kares",
                    Email = "kares@yahoo.com"
                };
            ...
            if (!_context.Trips.Any())
            {
                ...
                await _context.SaveChangesAsync(); //this will go and push that database
            }
        }
    }
}
